...
var RichMarkdownEditor = (_temp = _class = function (_React$PureComponent) {
  ...
  this.render = function () {
    var _props = _this2.props,
        ...
        hideBlockInsert = _props.hideBlockInsert,
        toc = _props.toc,
        pretitle = _props.pretitle,
        placeholder = _props.placeholder,
        portalRef = _props.portalRef,
...
}, ";margin:0;padding-left:10px;font-style:italic;}table{border-collapse:collapse;}tr{border-bottom:1px solid #eee;}th{font-weight:bold;}th,td{padding:5px 20px 5px 0;}b,strong{font-weight:600;}span[data-slate-zero-width]{display:inline-block;}");

...
var BlockToolbar = (_dec = (0, _reactKeydown2.default)("esc"), (_class = function (_React$Component) {
  ...
  _createClass(BlockToolbar, [{
    ...
    value: function render() {
      ...
      return React.createElement(
        Bar,
        _extends({ active: active }, attributes, { innerRef: function innerRef(ref) {
            return _this4.bar = ref;
          } }),
...
var Bar = /*#__PURE__*/(0, _reactEmotion2.default)(_Flex2.default, {
  target: "e11ydtcl1"
})("z-index:300;animation:", _animations.fadeIn, " 150ms ease-in-out;position:relative;align-items:center;background:", function (props) {
